                        ...
                        <li class="item">
                            ...
                            <div class="itemright">
                                ...
                                <div class="extra">
                                    ...
                                    <span> &nbsp; &nbsp; &nbsp; </span>
                                    <a class="favorites" href="addToWishList.php?id=<?php echo urlencode($row['PaintingID']) ?>&title=<?php echo urlencode($row['Title']) ?>&imageName=<?php echo urlencode($row['ImageFileName'])?>"> Add to Wish List</a>
                                    <p>&nbsp;</p>
                                </div>
